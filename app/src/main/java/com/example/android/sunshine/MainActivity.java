...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... param)
        {
            ...
            try {
                String WeatherResponse = NetworkUtils.getResponseFromHttpUrl(weatherRequest);

                String[] simpleJsonWeather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, WeatherResponse);
